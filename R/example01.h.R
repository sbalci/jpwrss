...
Example01Options <- if (requireNamespace('jmvcore')) R6::R6Class(
    "Example01Options",
...
Example01Results <- if (requireNamespace('jmvcore')) R6::R6Class(
...
Example01Base <- if (requireNamespace('jmvcore')) R6::R6Class(
    "Example01Base",
