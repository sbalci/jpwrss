...
Example04Options <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "Example04Options",
...
Example04Results <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "Example04Results",
...
Example04Base <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "Example04Base",
