...
Example05Options <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "Example05Options",
...
Example05Results <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "Example05Results",
...
Example05Base <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "Example05Base",
