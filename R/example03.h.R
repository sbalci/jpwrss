...
Example03Options <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "Example03Options",
...
Example03Results <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "Example03Results",
...
Example03Base <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "Example03Base",
