...
Example02Options <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "Example02Options",
...
Example02Results <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "Example02Results",
...
Example02Base <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "Example02Base",
